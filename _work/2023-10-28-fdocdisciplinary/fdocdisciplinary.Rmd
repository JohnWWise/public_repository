...
Please excuse the dust below, I will clean it up later.

```{r}
violations_survival <- c(
...
```{r}
prison_problem <- c("Being in unauthorized area", "Unauthorized absence from assigned area", "Possession of escape paraphernalia", "Unauthorized possession/use of communication device/technology", "Visiting regulation violations", "Possession of tobacco-related product by non-death row or non-community release inmate", "Telephone regulation violations", "Introduction of any contraband", "Personal or business relationship with staff member or volunteer", "Missing count", "Mail regulation violations", "Use of Alcohol", "Possession of unauthorized clothing or linen", "Escape or escape attempt", "Failure to proceed to/from designated area", "Possession of tobacco-related product by death row inmate")
```
...
category_mapping <- list(
  "Surviving Prison" = violations_survival,
  "Drug Violations" = drugs,
  "Officer Got Angry" = officer_angry,
  "Only a Problem in Prison" = prison_problem,
...
disc %>%
  ...
  coord_flip() +
  theme(
    axis.text.y = element_text(hjust = 1, vjust = 0.5, face = "bold", size = 8.5),  # Make y-axis text bold
...
ggsave('catted_outcomes_violations.png')
```
