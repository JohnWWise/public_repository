...
<ul>
    <li>
      <details>
        <summary>Data Wrangling for Interactive Visual</summary>
        <p>
...
Unfortunately, it does not appear to be possible to embed a D3 dynamic visual within a Distill website. Please click the link to view the visual.
