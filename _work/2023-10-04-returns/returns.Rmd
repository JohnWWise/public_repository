...
I have a lot to say about these results.

Correlation is not causation, of course. However, let's start by discussing the crime categories that exhibit a statistically significant trend.
...
We do have strong statistical evidence that indicates a trend of decreasing Abuse/Neglect Crimes, Sex Crimes, and Violent Crimes. We also see in increase in the proportion of Burglary, Theft, Property Crimes, as well as Druf Offenses.

Here are my thoughts summarized, with a statistical investigation to follow up within the week (hopefully tomorrow, depending on my cat):

- The decline in Abuse/Neglect Crimes across incarcerations suggests an increased stigma associated with multiple incarcerations. Individuals who are frequently in and out of prison are becoming less trusted over time.
- The proportion of persons associated with sex crimes decreases significantly between the first and second prison stays but then stabilizes. Initially, it was thought that this decrease could be attributed to the aggressive prosecution of individuals involved in the possession of child pornography. However, further investigation indicates that this may not be the case. Further investigation is required.
- Violent crimes decrease over multiple incarcerations simply because multiple incarcerations are correlated with age. As people grow older, they tend to become less violent in general.
- The proportions of Drug Offenses, as well as Burglary, Theft, and Property Crimes, increase over time because prison negatively impacts individuals and makes them more desperate.

# Next Steps
In a similar manner to how I presented a table and graph displaying proportions of crime categories across succeeding  incarcerations, I can create a table for individual crime adjudications showing statistically significant trends based on the number of incarcerations.
