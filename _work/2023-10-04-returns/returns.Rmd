...
# Next Steps
If you happened to notice that the percentages in the table above have noticeably shifted today, Monday the 16th of October, it's because I realized today that I was using the past conviction history of those who are currently back in FDOC, instead of looking at the crimes associated with their current incarceration. I have corrected this mistake (and also combined the sparse category of probation/parole violation convictions into crimes of incarceration and criminal identity). What is really exciting is that the numbers did noticeably shift after the correction. The next step is to explore that more explicitly — to examine how the proportions shift across the populations of individuals in prison for their first, second, third, etc., prison stays.
