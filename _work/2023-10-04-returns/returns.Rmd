...
Think about this, though: Having 3.2 years of freedom is actually enough time for someone to regain some responsibility and dignity -- it is already difficult to regain these once(or maybe for the first time), but to only have a fleeting taste of them? I do not know that I could recover from something like that.
...
**crime categories are under active review and adjustment -- many crimes are still coded incorrectly please have no faith in the valididty of the final table presented just above**