...
quartile_table <- data.frame(
  "Quartile" = c("Q1", "Median (Q2)", "Q3"),  # Change the column name here
...
We often come across statistics that state "X amount of prisoners will return within 3 years". However, a more appropriate framing would be that among those currently incarcerated in Florida who have served time previously, a staggering quarter of them were returned to prison in less than 1.8 years after their most recent release. Half were not out longer than 3.2 years. Additionally, only 25% of them were able to stay out of prison for longer than 5.7 years.

This subtle change in framing highlights the inefficiency of traditional carceral structures in "preventing recidivism" while maintaining proper responsibility attribution to the correctional agency.
