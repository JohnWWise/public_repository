...
```{r plotting RMC, echo=FALSE, layout="l-page", fig.align='center', fig.height=6, fig.width= 10, warning=FALSE, message=FALSE, code_folding = TRUE}
...
```{r fig.align='center', warning=FALSE, code_folding=TRUE, layout= 'l-page'}
point_size <- 3
