...
description: |
  The Florida Department of Corrections hosts a webpage called "Inmate Mortality" on their website; this document is an ONGOING mining of that data. (NOTE, error discovered and corrected 2023-09-26 1:51 pm, typoed entry "Acdident" (sic) was erroously cleaned and recoded to the value "Suicide". Now amended to be the proper "Accident".)
output:
...
```{r leaflet and kable function def, echo=FALSE, code_folding = TRUE}
...
```{r, echo=FALSE, fig.align='center', fig.height=8, fig.width= 10, warning=FALSE, message=FALSE, code_folding = TRUE}
mapping_naturals('2022-05-01')
```

```{r, echo=FALSE, code_folding = TRUE}
create_kable_table('2022-05-01')
```

### June 2022

```{r, echo=FALSE, fig.align='center', fig.height=8, fig.width= 10, warning=FALSE, message=FALSE, code_folding = TRUE}
mapping_naturals('2022-06-01')
```

```{r, echo=FALSE, code_folding = TRUE}
create_kable_table('2022-06-01')
```
