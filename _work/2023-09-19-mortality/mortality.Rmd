...
```
You can download this cleaned data as an csv file here: [Download deaths1.csv](deaths1.csv).
...
```
You can download this cleaned data as an csv file here: [Download deaths2.csv](deaths2.csv).
